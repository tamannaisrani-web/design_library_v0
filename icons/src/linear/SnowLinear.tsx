...
const SnowLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M19.7898 16.5L15.0298 13.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M19.7898 7.5L15.0298 10.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
SnowLinear.displayName = 'SnowLinear'

export { SnowLinear }
export default SnowLinear

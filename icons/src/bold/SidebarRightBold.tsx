...
const SidebarRightBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M16.7803 2.03003V21.98C18.0103 21.9 19.0503 21.55 19.8703 20.95C20.2903 20.66 20.6603 20.29 20.9503 19.87C21.6403 18.92 22.0003 17.68 22.0003 16.19V7.81003C22.0003 4.37003 20.0603 2.24003 16.7803 2.03003Z" fill="currentColor"/>
  </svg>
)

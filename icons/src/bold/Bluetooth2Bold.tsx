...
const Bluetooth2Bold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M12.2998 17.32L14.6098 15.39L12.2998 13.3V17.32Z" fill="currentColor"/>
<path d="M12.2998 6.67993V10.6399L14.6098 8.51993L12.2998 6.67993Z" fill="currentColor"/>

...
const MagicStarBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M21.4399 20.4702L18.4099 17.4402C18.1199 17.1502 17.6399 17.1502 17.3499 17.4402C17.0599 17.7302 17.0599 18.2102 17.3499 18.5002L20.3799 21.5302C20.5299 21.6802 20.7199 21.7502 20.9099 21.7502C21.0999 21.7502 21.2899 21.6802 21.4399 21.5302C21.7299 21.2402 21.7299 20.7602 21.4399 20.4702Z" fill="currentColor"/>
  </svg>
)

MagicStarBold.displayName = 'MagicStarBold'

export { MagicStarBold }

...
const BluetoothRectangleBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M12.8999 16.3299L14.5699 14.9399L12.8999 13.4099V16.3299Z" fill="currentColor"/>

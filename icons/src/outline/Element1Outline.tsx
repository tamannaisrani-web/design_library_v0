...
const Element1Outline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Element1Outline.displayName = 'Element1Outline'

export { Element1Outline }
export default Element1Outline

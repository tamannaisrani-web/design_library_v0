...
const UserSearchOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M22 22.75C21.81 22.75 21.6199 22.68 21.4699 22.53L20.4699 21.53C20.1799 21.24 20.1799 20.7599 20.4699 20.4699C20.7599 20.1799 21.24 20.1799 21.53 20.4699L22.53 21.4699C22.82 21.7599 22.82 22.24 22.53 22.53C22.38 22.68 22.19 22.75 22 22.75Z" fill="currentColor"/>
  </svg>
)

UserSearchOutline.displayName = 'UserSearchOutline'

export { UserSearchOutline }

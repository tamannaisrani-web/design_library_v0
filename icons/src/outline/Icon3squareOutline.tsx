...
const Icon3squareOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Icon3squareOutline.displayName = '3squareOutline'

export { Icon3squareOutline }
export default Icon3squareOutline

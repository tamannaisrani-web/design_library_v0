...
const GalleryOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M2.66977 19.7C2.42977 19.7 2.18977 19.58 2.04977 19.37C1.81977 19.03 1.90977 18.56 2.25977 18.33L7.18977 15.02C8.26977 14.29 9.75977 14.38 10.7398 15.21L11.0698 15.5C11.5698 15.93 12.4198 15.93 12.9098 15.5L17.0698 11.93C18.1298 11.02 19.7998 11.02 20.8698 11.93L22.4998 13.33C22.8098 13.6 22.8498 14.07 22.5798 14.39C22.3098 14.7 21.8398 14.74 21.5198 14.47L19.8898 13.07C19.3898 12.64 18.5398 12.64 18.0398 13.07L13.8798 16.64C12.8198 17.55 11.1498 17.55 10.0798 16.64L9.74977 16.35C9.28977 15.96 8.52977 15.92 8.01977 16.27L3.08977 19.58C2.95977 19.66 2.80977 19.7 2.66977 19.7Z" fill="currentColor"/>
  </svg>
)

GalleryOutline.displayName = 'GalleryOutline'

export { GalleryOutline }

...
const BroomLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M9.87006 5.66998L6.45006 7.74999L4.89007 5.19C4.32007 4.25 4.62006 3.01 5.56006 2.44C6.50006 1.87 7.74006 2.16998 8.31006 3.10998L9.87006 5.66998Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>

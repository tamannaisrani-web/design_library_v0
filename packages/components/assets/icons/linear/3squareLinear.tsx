...
const Icon3squareLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Icon3squareLinear.displayName = '3squareLinear'

export { Icon3squareLinear }
export default Icon3squareLinear

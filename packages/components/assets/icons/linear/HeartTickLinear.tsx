...
const HeartTickLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M22 17.1999C22 18.0999 21.75 18.9499 21.3 19.6699C20.47 21.0599 18.95 21.9999 17.2 21.9999C15.45 21.9999 13.92 21.0599 13.1 19.6699C12.66 18.9499 12.4 18.0999 12.4 17.1999C12.4 14.5499 14.55 12.3999 17.2 12.3999C19.85 12.3999 22 14.5499 22 17.1999Z" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>

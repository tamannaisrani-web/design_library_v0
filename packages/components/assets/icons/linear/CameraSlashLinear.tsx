...
const CameraSlashLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M6.75977 22H17.2398C19.9998 22 21.0998 20.31 21.2298 18.25L21.7498 9.99001C21.8098 9.06001 21.5198 8.19001 21.0098 7.51001" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>

...
const EmptyWalletRemoveLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M6.07001 20.0399L3.95001 17.9299" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.04999 17.96L3.92999 20.0699" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

EmptyWalletRemoveLinear.displayName = 'EmptyWalletRemoveLinear'

export { EmptyWalletRemoveLinear }

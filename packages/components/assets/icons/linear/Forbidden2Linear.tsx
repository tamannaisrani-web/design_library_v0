...
const Forbidden2Linear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Forbidden2Linear.displayName = 'Forbidden2Linear'

export { Forbidden2Linear }
export default Forbidden2Linear

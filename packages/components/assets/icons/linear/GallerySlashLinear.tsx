...
const GallerySlashLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M11.4302 16.45C11.7302 16.75 12.2202 16.75 12.5202 16.45L17.5502 11.41C18.3302 10.63 19.5902 10.63 20.3702 11.41L22.0002 13.05" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

GallerySlashLinear.displayName = 'GallerySlashLinear'

export { GallerySlashLinear }

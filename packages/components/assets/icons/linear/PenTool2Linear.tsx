...
const PenTool2Linear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M10.7501 22.5001H13.2701C14.2301 22.5001 14.8501 21.8201 14.6701 20.9901L14.2601 19.1802H9.76007L9.35008 20.9901C9.17008 21.7701 9.85007 22.5001 10.7501 22.5001Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>

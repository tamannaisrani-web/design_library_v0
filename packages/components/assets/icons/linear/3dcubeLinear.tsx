...
const Icon3dcubeLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Icon3dcubeLinear.displayName = '3dcubeLinear'

export { Icon3dcubeLinear }
export default Icon3dcubeLinear

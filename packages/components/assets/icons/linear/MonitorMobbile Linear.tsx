...
const MonitorMobbile Linear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
MonitorMobbile Linear.displayName = 'MonitorMobbile Linear'

export { MonitorMobbile Linear }
export default MonitorMobbile Linear

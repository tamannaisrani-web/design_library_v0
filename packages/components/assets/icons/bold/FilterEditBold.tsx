...
const FilterEditBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M20.58 4.02V4.98C20.58 5.39 20.11 5.64 19.74 5.45C19.28 5.21 18.79 5.03 18.27 4.91C17.83 4.8 17.36 4.75 16.88 4.75C13.43 4.75 10.63 7.55 10.63 11C10.63 12.14 10.94 13.26 11.53 14.22C12.03 15.06 12.73 15.76 13.49 16.23C13.66 16.34 13.84 16.44 14.01 16.54C14.18 16.63 14.3 16.81 14.3 17V19.07C14.3 19.68 13.9 20.49 13.4 20.79L12 21.7C10.7 22.51 8.91004 21.6 8.91004 19.98V14.63C8.91004 13.92 8.51004 13.01 8.11004 12.51L4.32004 8.47C3.82004 7.96 3.42004 7.05 3.42004 6.45V4.12C3.42004 2.91 4.32004 2 5.41004 2H18.59C19.68 2 20.58 2.91 20.58 4.02Z" fill="currentColor"/>
  </svg>
)

FilterEditBold.displayName = 'FilterEditBold'

export { FilterEditBold }

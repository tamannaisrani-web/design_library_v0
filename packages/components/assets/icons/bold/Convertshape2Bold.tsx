...
const Convertshape2Bold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Convertshape2Bold.displayName = 'Convertshape2Bold'

export { Convertshape2Bold }
export default Convertshape2Bold

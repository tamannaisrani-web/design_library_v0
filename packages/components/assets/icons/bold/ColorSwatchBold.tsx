...
const ColorSwatchBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M21.9999 16.5V19.5C21.9999 20.88 20.8799 22 19.4999 22H12.3599C11.4699 22 11.0299 20.93 11.6499 20.3L17.5199 14.3C17.7099 14.11 17.9699 14 18.2299 14H19.4999C20.8799 14 21.9999 15.12 21.9999 16.5Z" fill="currentColor"/>

...
const DocumentCloudBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M14.7596 19.2601C12.4096 19.4301 12.4096 22.8301 14.7596 23.0001H20.3196C20.9896 23.0001 21.6496 22.7501 22.1396 22.3001C23.7896 20.8601 22.9096 17.9801 20.7396 17.7101C19.9596 13.0201 13.1796 14.8001 14.7796 19.2701" fill="currentColor"/>

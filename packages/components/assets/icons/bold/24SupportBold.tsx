...
const Icon24SupportBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Icon24SupportBold.displayName = '24SupportBold'

export { Icon24SupportBold }
export default Icon24SupportBold

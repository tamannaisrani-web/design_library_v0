...
const SidebarBottomBold = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M3.04953 19.87C3.33953 20.29 3.70953 20.66 4.12953 20.95C5.07953 21.64 6.31953 22 7.80953 22H16.1895C19.6295 22 21.7595 20.06 21.9695 16.78H2.01953C2.09953 18.01 2.44953 19.05 3.04953 19.87Z" fill="currentColor"/>

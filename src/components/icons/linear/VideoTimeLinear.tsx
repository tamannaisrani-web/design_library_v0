...
const VideoTimeLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M18.7799 17.0901V18.7801L17.3799 19.6201" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

VideoTimeLinear.displayName = 'VideoTimeLinear'

export { VideoTimeLinear }

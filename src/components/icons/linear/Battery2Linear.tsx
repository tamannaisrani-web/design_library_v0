...
const Battery2Linear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
Battery2Linear.displayName = 'Battery2Linear'

export { Battery2Linear }
export default Battery2Linear

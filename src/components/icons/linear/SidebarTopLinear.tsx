...
const SidebarTopLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M14.5604 15.4999L12.0004 12.9399L9.44043 15.4999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

SidebarTopLinear.displayName = 'SidebarTopLinear'

export { SidebarTopLinear }

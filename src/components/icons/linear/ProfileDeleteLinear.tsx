...
const ProfileDeleteLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M11.9998 21.8102C10.1798 21.8102 8.3698 21.3502 6.9898 20.4302C4.5698 18.8102 4.5698 16.1702 6.9898 14.5602C9.7398 12.7202 14.2498 12.7202 16.9998 14.5602" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

ProfileDeleteLinear.displayName = 'ProfileDeleteLinear'

export { ProfileDeleteLinear }

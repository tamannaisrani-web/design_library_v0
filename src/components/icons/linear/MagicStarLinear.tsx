...
const MagicStarLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M21.9102 21.9997L18.8802 18.9697" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

MagicStarLinear.displayName = 'MagicStarLinear'

export { MagicStarLinear }

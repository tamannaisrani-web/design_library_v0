...
const Forward5SecondsLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M13.9098 10.83H10.8498L10.0898 13.12H12.3798C13.2198 13.12 13.9098 13.8 13.9098 14.65C13.9098 15.49 13.2298 16.18 12.3798 16.18H10.0898" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

Forward5SecondsLinear.displayName = 'Forward5SecondsLinear'

export { Forward5SecondsLinear }

...
const ShieldCrossLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M14.1504 13.4399L9.90039 9.18994" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14.0996 9.24023L9.84961 13.4902" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

ShieldCrossLinear.displayName = 'ShieldCrossLinear'

export { ShieldCrossLinear }

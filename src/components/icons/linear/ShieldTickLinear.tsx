...
const ShieldTickLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M9.0498 11.8702L10.6598 13.4802L14.9598 9.18018" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

ShieldTickLinear.displayName = 'ShieldTickLinear'

export { ShieldTickLinear }

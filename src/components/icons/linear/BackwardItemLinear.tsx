...
const BackwardItemLinear = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M17.3801 11.0001V13.6201C17.3801 16.3101 16.3101 17.3801 13.6201 17.3801H11.0001V16.1501C11.0001 13.9001 10.1001 13.0001 7.85011 13.0001H6.62012V10.3801C6.62012 7.69013 7.69011 6.62012 10.3801 6.62012H13.0001V7.85013C13.0001 10.1001 13.9001 11.0001 16.1501 11.0001H17.3801Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)

BackwardItemLinear.displayName = 'BackwardItemLinear'

export { BackwardItemLinear }

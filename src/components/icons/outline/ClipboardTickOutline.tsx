...
const ClipboardTickOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M10.81 16.9499C10.62 16.9499 10.43 16.8799 10.28 16.7299L8.78 15.2299C8.49 14.9399 8.49 14.4599 8.78 14.1699C9.07 13.8799 9.55 13.8799 9.84 14.1699L10.81 15.1399L14.28 11.6699C14.57 11.3799 15.05 11.3799 15.34 11.6699C15.63 11.9599 15.63 12.4399 15.34 12.7299L11.34 16.7299C11.2 16.8799 11 16.9499 10.81 16.9499Z" fill="currentColor"/>

...
const ForbiddenOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M4.93988 19.83C4.74988 19.83 4.55988 19.76 4.40988 19.61C4.11988 19.32 4.11988 18.84 4.40988 18.55L18.5499 4.41C18.8399 4.12 19.3199 4.12 19.6099 4.41C19.8999 4.7 19.8999 5.18 19.6099 5.47L5.46988 19.61C5.31988 19.76 5.12988 19.83 4.93988 19.83Z" fill="currentColor"/>
  </svg>
)

ForbiddenOutline.displayName = 'ForbiddenOutline'

export { ForbiddenOutline }

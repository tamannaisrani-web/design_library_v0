...
const FolderMinusOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
<path d="M14.43 15.2998H9.42999C9.01999 15.2998 8.67999 14.9598 8.67999 14.5498C8.67999 14.1398 9.01999 13.7998 9.42999 13.7998H14.43C14.84 13.7998 15.18 14.1398 15.18 14.5498C15.18 14.9598 14.84 15.2998 14.43 15.2998Z" fill="currentColor"/>

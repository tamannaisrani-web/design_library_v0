...
const 3squareOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
3squareOutline.displayName = '3squareOutline'

export { 3squareOutline }
export default 3squareOutline

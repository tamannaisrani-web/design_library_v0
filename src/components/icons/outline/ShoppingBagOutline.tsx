...
const ShoppingBagOutline = ({ size = 24, ...props }: IconProps): React.ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
<path d="M20.41 17.7803H8C7.59 17.7803 7.25 17.4403 7.25 17.0303C7.25 16.6203 7.59 16.2803 8 16.2803H20.41C20.82 16.2803 21.16 16.6203 21.16 17.0303C21.16 17.4403 20.82 17.7803 20.41 17.7803Z" fill="currentColor"/>
  </svg>
)

ShoppingBagOutline.displayName = 'ShoppingBagOutline'

export { ShoppingBagOutline }
